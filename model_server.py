...
if quantized_version: 
    ap.add_argument('--model', type=str , default="C:\Projects\MiniCPM-o-2_6-int4", help="huggingface model name or local path")
else: 
    ap.add_argument('--model', type=str , default="C:\Projects\MiniCPM-o-2_6", help="huggingface model name or local path")
args = ap.parse_args()
